...
class publicview extends file
{
	...
	function UsersArray($value=null,$placeholder=null,$combine='AND'){
		if(isset($_SESSION['id'])||$value!=null){
			...
			return $this->getArray('users',$placeholderset,$setvalue,$combine,1,$join);			
		}
		return null;		
	}
	function ownerData(){		
	...
	function get_data($data=null,$table,$placeholder=null,$conditions=null,$combine='AND',$limit=null,$join=array(),$attr=array()){    
		if (empty($table)) 
		return null;
	...
	function getArray($table,$placeholder=null,$conditions=null,$combine='AND',$limit=1,$join=array(),$attr=array()){//gives one array		
		return $this->get_data('',$table,$placeholder,$conditions,$combine,$limit,$join,$attr);
	}	  
