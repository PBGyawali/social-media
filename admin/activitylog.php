...
<h1 class="alert-primary text-center ">Activity log </h1>
 ...
 <?php if (isset($logs)&&!empty($logs)): ?> 
        ...
        <div class="row <?=$log['type'];?>" id="alert_header_<?=$log['id'];?>">
        ...
        <a class="dropdown-item pt-0 logaction" role="presentation" data-action="delete" data-type="<?=$log['type'];?>" data-id="<?=$log['id'];?>" >Delete this</a>  
        <a class="dropdown-item pt-0 logaction" role="presentation" data-action="delete_similar" data-type="<?=$log['type'];?>" data-id="<?=$log['id'];?>">Clean related logs</a>        
        </div>
        </div>
        </div>
        </div>
