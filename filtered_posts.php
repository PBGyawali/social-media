...
<?php else: ?>
	...
	<div class="card mb-5">	
      ...
      <div class="card-body">
	<span class="navbar-brand ">NO POST FOUND</span>
	</div>
  </div>
	</div>
    			...
    			<div class="card mb-5">	
					...
					<div class="card-body">
						...
						<p class="text-primary">
							<span class=" float-right mr-1">Read more...</span>
						</p>
					</div>
					<div class="card-footer">
						<small class="text-secondary">
							Last updated: <time class="timeago" datetime="<?php echo $post['updated_at']?>"><?php if (!$post['updated_at']) echo'unknown';?></time>
						</small>
					</div> 
				</div>
			</a>
