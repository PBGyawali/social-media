...
$row=$katha->UsersArray($id);
$profileimage=urlencode($file->image_check($row['profile_image'],USER_IMAGES_DIR));
    ...
    <div class="main-body">
          ...
          <nav aria-label="breadcrumb" class="main-breadcrumb">
            <ol class="breadcrumb">
              ...
              echo '<li class="breadcrumb-item"><a href="'.BASE_URL.'user_dashboard.php">Dashboard</a></li>';
              ?>
              ...
              <div class="card">
                <div class="card-body">
                  <div class="d-flex flex-column align-items-center text-center">
                    <img src=" <?php echo  USER_IMAGES_URL.urlencode($profileimage)?> " alt="Admin" class="rounded-circle" width="150">
                    <div class="mt-3">
                ...
                <div class="col-sm-6 mb-3">
                  <div class="card h-100">
                    <div class="card-body">
                      ...
                      <small>Profile coompletion</small>
                      <div class="progress mb-3" style="height: 5px">
